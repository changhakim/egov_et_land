...
compo = {
	...
	prod_post:()=>{
		...
		+'                <input type="text" class="form-control" id="category_id" placeholder="" value="스마트폰" required="">'
		...
		+'                <input type="text" class="form-control" id="unit" placeholder="재고 입력"  required="">'
		+'                <div class="invalid-feedback">'
		+'                </div>'
		+'              </div>'
		+'            </div>'
		...
		+'                  <option class = "supplier" value="samsung">삼성전자</option>'
		+'                  <option class = "supplier" value="lg">LG전자</option>'
		+'                  <option class = "supplier" value="apple">애플</option>'
		+'                  <option class = "supplier" value="xaomi">샤오미</option>'
